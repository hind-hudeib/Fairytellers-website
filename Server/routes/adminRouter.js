...
// all donors
router.get("/dashboard/donors", adminController.allUsers);

// delete donor
router.put("/dashboard/upDonors/:id", adminController.deleteUser);
...
router.get(
  "/dashboard/charitiesNotActive",
  adminController.allCharitiesNotActive
);
...
router.get(
  "/dashboard/notActiveDonations",
  adminController.allDonationsNotActive
);
...
router.get(
  "/dashboard/orgRequestDonation",
  adminController.allOrgRequestDonation
);

// accept org request on donation
router.put(
  "/dashboard/acceptOrgRequestDonation/:id",
  adminController.acceptOrgRequestDonation
);
